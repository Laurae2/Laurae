...
| --- | :---: | --- |
| LightGBM | YES | lgbm.train, lgbm.predict, lgbm.cv, lgbm.fi |
...
| lgbm.train | LightGBM trainer | Trains a LightGBM model. Full verbosity control, with logging to file possible. |
