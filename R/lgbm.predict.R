...
lgbm.predict <- function(
  ...
  write(paste0('header=', tolower(header)), fileConn, append = TRUE)
  write(paste0('label=', ifelse(is.character(label_column), paste0("name:", label_column), label_column)), fileConn, append = TRUE)
